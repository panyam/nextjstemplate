...
export default class Header extends BaseComponent<{
  ...
  constructor(props: any, context: any) {
    ...
    this.state = {
      ...
      logoContents: this.props.logoContents || (<a href="/" className={this.styles.headerLogo}> NextJS Template </a>),
    };
  }
        ...
        <div className={styles.searchPanel}>
          <form ref={this.searchFormRef} className={styles.searchForm}
            ...
            <div className={styles.searchInputContainer}>
              ...
              <input type="submit" className={styles.submitSearchButton} value = "Search" />
            </div>
            <div className="searchPanelBottom"></div>
          </form>
        </div>
      </>
    );
